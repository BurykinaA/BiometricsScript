...
MODEL_MAPPING = {"MiniFASNetV2": MiniFASNetV2}


class Detection:
    def __init__(self):
        caffemodel = "MiniFasNet/detection_model/Widerface-RetinaFace.caffemodel"
        deploy = "MiniFasNet/detection_model/deploy.prototxt"
